...
public class SmackXMPPTest {
   ...
   /** openfire服务器address */
   private final static String server = "laptop-b8r4gof9";
   ...
   public void testUser() {
       try {
           /** 用户登陆，用户名、密码 */
           connection.login("admin", "whosyourdaddy628");
       } catch (XMPPException e) {
           e.printStackTrace();
       }
       /** 获取当前登陆用户 */
   ...
   public static void main(String[] args) {
	   SmackXMPPTest test = new SmackXMPPTest();
	   test.init();
	   test.testPacket();
   }
}
